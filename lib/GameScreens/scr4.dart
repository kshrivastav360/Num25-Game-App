...
import 'package:numberproj/ResultScreens/result5.dart';
import 'package:numberproj/StartScreens/loginscr.dart';
import 'package:icons_plus/icons_plus.dart';
import 'package:numberproj/provider/placepro.dart';
import 'package:numberproj/ResultScreens/result4.dart';
import 'package:numberproj/ResultScreens/result6.dart';
import 'package:shared_preferences/shared_preferences.dart';

// ignore: must_be_immutable
class HomeScreen4 extends ConsumerStatefulWidget {
  HomeScreen4({super.key, this.name});
  late String? name;
  @override
  ConsumerState<HomeScreen4> createState() => _HomeScreen4State();
}

class _HomeScreen4State extends ConsumerState<HomeScreen4> {
  ...
  Future<void> updateScore(int scr, int time) async {
    ...
    final url = Uri.parse(
        'http://77.37.44.61:8086/mpuzzle2/leader/update/$phNo/$scr/$time/${5}');
    print("time : $time, $level");
    try {
      ...
      if (response.statusCode == 200) {
        Navigator.push(
            context,
            PageRouteBuilder(
              pageBuilder: (context, animation, secondaryAnimation) => Marks5(
                mark: scr,
              ),
              transitionsBuilder:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Level 5",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 18,color: Color.fromARGB(255, 36, 224, 26)),),
