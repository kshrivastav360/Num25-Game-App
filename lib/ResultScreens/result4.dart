...
class Marks4 extends StatefulWidget {
  const Marks4({super.key, required this.mark});
  final int mark;

  @override
  State<Marks4> createState() => _Marks4State();
}

class _Marks4State extends State<Marks4> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          filterLvl = allScoreTime.where((element) => element['level'] == 4).toList();
