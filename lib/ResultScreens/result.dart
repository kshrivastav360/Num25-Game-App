...
class Marks extends StatefulWidget {
  const Marks({super.key, required this.mark, required this.phno});
  final int mark;
  final String phno;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          filterLvl = allScoreTime.where((element) => element['level']<=1).toList();
        });
        ...
        child: Stack(
          children: [
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    username = allScoreTime[index]["username"] ?? '';
                    print(username);
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          const Icon(Icons.person,color: Color.fromARGB(255, 147, 255, 93),size: 17,),
                                          Text(
                                            username,
                                            style: const TextStyle(
                                                color: Colors.white),
            ...
            Padding(
              ...
              pageBuilder: (context, animation, secondaryAnimation) => const Levels(),
              transitionsBuilder:
