...
class Marks5 extends StatefulWidget {
  const Marks5({super.key, required this.mark});
  final int mark;

  @override
  State<Marks5> createState() => _Marks5State();
}

class _Marks5State extends State<Marks5> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          filterLvl = allScoreTime.where((element) => element['level'] == 5).toList();
