...
class Marks2 extends StatefulWidget {
  const Marks2({super.key, required this.mark});
  final int mark;

  @override
  State<Marks2> createState() => _Marks2State();
}

class _Marks2State extends State<Marks2> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          filterLvl =
              allScoreTime.where((element) => element['level'] == 2).toList();
        });
