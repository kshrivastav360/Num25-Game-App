...
class Marks3 extends StatefulWidget {
  const Marks3({super.key, required this.mark});
  final int mark;

  @override
  State<Marks3> createState() => _Marks3State();
}

class _Marks3State extends State<Marks3> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          filterLvl =
              allScoreTime.where((element) => element['level'] == 3).toList();
        });
        ...
        child: Stack(
          children: [
            ...
            Padding(
              ...
              child: Visibility(
               // visible: filterLvl.any((element) => element['score'] >= 15),
